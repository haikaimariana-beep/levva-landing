...
export const CASES: CaseProva[] = [
  {
    ...
    cliente: 'Ambev',
    segmento: 'Bebidas',
    contexto: 'economia · Dados & Decisão',
    logo: ambev,
  },
  {
    numero: '98%',
    ...
    contexto: 'precisão documental · +100 pessoas treinadas',
    logo: ems,
  },
  {
    numero: '+120%',
    ...
    contexto: 'velocidade no mapeamento da jornada',
    logo: b3,
  },
  {
    numero: '75%',
    cliente: 'Stoller',
    segmento: 'Agro',
    contexto: 'retenção de usuários · app novo, do zero',
    logo: stoller,
  },
  {
    numero: '3x',
